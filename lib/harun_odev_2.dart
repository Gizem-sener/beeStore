import 'package:beestore/parcalar/anasayfa_urun_widget.dart';
...
/*
    //Tekrar eden sayaç(zamana bağlı işlemler için)
                              ...
                              children: [
                                Row(
                                  children: [
                                    Column(
                                      children: [
                                        Image.asset("varliklar/Running.png"),
                                        const Padding(
                                    ...
                                    Column(
                                      children: [
                                        Image.asset("varliklar/Sneakers.png"),
                                        const Padding(
                                          padding: EdgeInsets.all(8.0),
                                          child: Text("Sneakers"),
                                        ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Column(
                                        children: [
                                          Image.asset("varliklar/Wrist.png"),
                                          const Padding(
                                            padding: EdgeInsets.all(8.0),
                                      ...
                                      Column(
                                        children: [
                                          Image.asset("varliklar/Speaker.png"),
                                          const Padding(
                                            padding: EdgeInsets.all(8.0),
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image:
                                      AssetImage("varliklar/ProfilePic.jpg")),
                            ),
                          ),
                        ],
                      ),
